...
void ResidualBlockInfo::Evaluate()
{
    ...
    {
        jacobians[i].resize(cost_function->num_residuals(), block_sizes[i]);  //残差对相应变量求导
...
// 对ResidualBlockInfo求残差和雅克比，并将参数信息parameter_blocks添加到parameter_block_data
...
void MarginalizationInfo::marginalize()
{
    ...
    // 将全部parameter_block填充到了parameter_block_idx
